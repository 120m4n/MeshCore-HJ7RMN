...
- [ ] **Step 3: Verify `TEMP_STATUS` on an authorized channel**
...
- [ ] **Step 4: Verify unauthorized channels are silently ignored**
...
- [ ] **Step 5: Verify the "no reading yet" state**
...
- [ ] **Step 6: Verify the "cached" state**
...
- [ ] **Step 7: Verify the "i2c error" state**
...
- [ ] **Step 8: Verify no regression on the actuator (if both rigs share the bus)**
